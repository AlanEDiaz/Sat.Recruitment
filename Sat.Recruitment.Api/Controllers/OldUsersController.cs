...
{
    /// <summary>
    /// Old deprecated user controller
    /// </summary>
    [ApiController]
    [Obsolete("Old version of create user controller")]
    [Route("[controller]")]
    public partial class OldUsersController : ControllerBase
    {
